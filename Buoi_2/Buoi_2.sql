...
---
SELECT HOTEN,NGAYSINH,MANQL N'Người quản lý'
FROM NHANVIEN
WHERE PHAI = N'Nữ'
---
SELECT * FROM PHONGBAN
...
WHERE NHANVIEN.MAPH = PHONGBAN.MAPH AND TENPH = N'Kế hoạch'
---
SELECT HOTEN
FROM NHANVIEN
WHERE HOTEN LIKE N'Nguyễn%'
---
SELECT TENPH, COUNT (*) N'Số lượng NV'
FROM NHANVIEN,PHONGBAN
...
HAVING COUNT(*) > 3
---
SELECT HOTEN, YEAR(NGAYSINH) N'Năm sinh', DIACHI
FROM NHANVIEN, PHONGBAN
WHERE NHANVIEN.MAPH = PHONGBAN.MAPH AND (TENPH = N'Nhân sự' OR TENPH = N'Quản trị')
ORDER BY YEAR(NGAYSINH) ASC
---
SELECT HOTEN, YEAR(NGAYSINH) N'Năm sinh', DIACHI
FROM NHANVIEN, PHONGBAN
WHERE NHANVIEN.MAPH = PHONGBAN.MAPH AND (TENPH = N'Nhân sự' OR TENPH = N'Quản trị')
ORDER BY YEAR(NGAYSINH) ASC, TENPH DESC
---
